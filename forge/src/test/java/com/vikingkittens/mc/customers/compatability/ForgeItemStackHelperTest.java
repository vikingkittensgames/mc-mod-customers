...
class ForgeItemStackHelperTest {
    @BeforeAll
    ...
    void returnsLoaderCraftingRemainder() {
        ...
        assertSame(remainder, new ForgeItemStackHelper().getCraftingRemainder(stack));
    }

    @Test
    void returnsEmptyStackWithoutCraftingRemainder() {
        assertSame(ItemStack.EMPTY, new ForgeItemStackHelper().getCraftingRemainder(mock(ItemStack.class)));
    }
}
