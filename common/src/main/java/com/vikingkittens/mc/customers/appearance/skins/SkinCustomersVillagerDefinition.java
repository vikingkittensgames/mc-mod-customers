...
public record SkinCustomersVillagerDefinition(
    ...
    public static final Codec<SkinCustomersVillagerDefinition> CODEC =
            RecordCodecBuilder.create(instance -> instance.group(
                    Identifier.CODEC.fieldOf("texture").forGetter(SkinCustomersVillagerDefinition::texture),
                    ...
                    Codec.unboundedMap(Codec.STRING, Identifier.CODEC).optionalFieldOf("sounds", Map.of()).forGetter(SkinCustomersVillagerDefinition::sounds)
    ...
    public Optional<Identifier> getSound(SkinCustomersVillagerSound sound) {
        return Optional.ofNullable(sounds.get(sound.getSerializedName()));
    }

    public Identifier getTextureLocation() {
        return Identifier.fromNamespaceAndPath(texture.getNamespace(), "textures/customers/skins/" + texture.getPath() + ".png");
    }
}
