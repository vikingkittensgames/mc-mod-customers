...
public record SkinPackCustomersVillagerDefinition(String name, List<Identifier> skins) {
    public static final Codec<SkinPackCustomersVillagerDefinition> CODEC =
            RecordCodecBuilder.create(instance -> instance.group(
                    ...
                    Identifier.CODEC.listOf().fieldOf("skins").forGetter(SkinPackCustomersVillagerDefinition::skins)
